...
public class ToyRobotAttackGoal extends Goal {
    private final ToyRobotEntity entity;
    private final double moveSpeedAmp;
    private int attackTime = -1;

    public ToyRobotAttackGoal(ToyRobotEntity mob, double moveSpeedAmpIn) {
        this.entity = mob;
    ...
    public boolean canUse() {
        return this.entity.getActivatedStatus() && this.entity.getTarget() != null;
