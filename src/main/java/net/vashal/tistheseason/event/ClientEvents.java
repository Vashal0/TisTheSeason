...
import net.vashal.tistheseason.block.entity.RockingHorseRenderer;
...
public class ClientEvents {
    ...
    public static class ClientModBusEvents {
        ...
        public static void registerRenderers(final EntityRenderersEvent.RegisterRenderers event) {
            ...
            EntityRenderers.register(TTS_EntityTypes.DUMMY_ENTITY_TYPE.get(), EmptyRenderer::new);
            event.registerBlockEntityRenderer(TTSBlockEntities.ROCKING_HORSE.get(), RockingHorseRenderer::new);
