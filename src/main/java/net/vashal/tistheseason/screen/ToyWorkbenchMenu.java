...
public class ToyWorkbenchMenu extends AbstractContainerMenu {
    ...
    public ToyWorkbenchMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(3));
    }

    public ToyWorkbenchMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(TTS_MenuTypes.TOY_WORKBENCH_MENU.get(), id);
        checkContainerSize(inv, 4);
        blockEntity = (ToyWorkbenchBlockEntity) entity;
