...
public class ReindeerSlipperModel extends HumanoidModel<LivingEntity> {
	...
	public static LayerDefinition createLayer() {
		...
		PartDefinition LeftLeg = part.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(4, 14).addBox(-2.4175F, 9.5636F, -5.1063F, 5.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
		...
		PartDefinition RightLeg_r1 = LeftLeg.addOrReplaceChild("RightLeg_r1", CubeListBuilder.create().texOffs(2, 20).addBox(0.3583F, -1.4624F, -2.4562F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
				...
				.texOffs(16, 4).addBox(-4.1317F, -0.9508F, -2.1812F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1423F, 9.6831F, -1.225F, 0.0F, 0.0F, 0.3927F));
		...
		PartDefinition RightLeg_r2 = LeftLeg.addOrReplaceChild("RightLeg_r2", CubeListBuilder.create().texOffs(1, 20).addBox(-1.4118F, -1.4619F, -2.4312F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
				...
				.texOffs(0, 0).addBox(-1.6368F, -3.5369F, -2.2312F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1423F, 9.6831F, -1.225F, 0.0F, 0.0F, -0.3927F));

		PartDefinition LeftLeg_r1 = LeftLeg.addOrReplaceChild("LeftLeg_r1", CubeListBuilder.create().texOffs(16, 2).addBox(-1.6689F, -2.7405F, -2.0812F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1423F, 9.6831F, -1.225F, 0.0F, 0.0F, 0.7854F));

		PartDefinition LeftLeg_r2 = LeftLeg.addOrReplaceChild("LeftLeg_r2", CubeListBuilder.create().texOffs(16, 4).addBox(-0.8449F, -2.7543F, -2.2062F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1423F, 9.6831F, -1.225F, 0.0F, 0.0F, -0.7854F));

		PartDefinition rightleg = part.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(15, 11).addBox(-0.563F, 11.0233F, -5.7938F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition RightLeg_r3 = rightleg.addOrReplaceChild("RightLeg_r3", CubeListBuilder.create().texOffs(2, 20).addBox(0.4643F, -1.4581F, -2.2813F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
				...
				.texOffs(16, 1).addBox(-3.9008F, -1.0465F, -1.7563F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0782F, 9.6928F, -1.4125F, 0.0F, 0.0F, 0.3927F));
		...
		PartDefinition RightLeg_r4 = rightleg.addOrReplaceChild("RightLeg_r4", CubeListBuilder.create().texOffs(1, 20).addBox(-1.4059F, -1.4412F, -2.2813F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
				...
				.texOffs(2, 0).addBox(-1.4059F, -3.4412F, -1.7813F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0782F, 9.6928F, -1.4125F, 0.0F, 0.0F, -0.3927F));

		PartDefinition RightLeg_r5 = rightleg.addOrReplaceChild("RightLeg_r5", CubeListBuilder.create().texOffs(16, 2).addBox(-1.4922F, -2.9172F, -1.7563F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0782F, 9.6928F, -1.4125F, 0.0F, 0.0F, 0.7854F));

		PartDefinition RightLeg_r6 = rightleg.addOrReplaceChild("RightLeg_r6", CubeListBuilder.create().texOffs(16, 1).addBox(-0.6681F, -2.5775F, -1.7312F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0782F, 9.6928F, -1.4125F, 0.0F, 0.0F, -0.7854F));
